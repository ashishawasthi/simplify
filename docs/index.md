...
- [Platform](/platform/index.md) (5 documents) — How the app is built — the static shell, the tool contract, offline and updates, security headers, data and AI models.
